...
namespace WHMS.Infor_Data
{
    public partial class Program : System.Web.UI.Page
    {
        ...
        {
            DateTime datetime = date.SelectedDate.Value.Date;
            //查重
            ...
            while (flag)
            {
                ...
                {
                    Common.close();
                    string sqlstr2 = "insert into ProgramList (Program,SySe,Date) values ('" + selectPro.SelectedItem.Text + "','" + selectSy.SelectedItem.Text + "-" + selectSe.SelectedItem.Text + "','" + datetime + "')";
